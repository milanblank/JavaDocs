...
//            paramsMap.put(element, request.getParameter(element));
//        }

        List<String> enumerations = Collections.list(parameterNames);
        enumerations.stream().forEach(e -> paramsMap.put(e, request.getParameter(e)));
